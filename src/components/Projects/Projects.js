            ...
            <ProjectCard
              ...
              description={
                <span>
                  ...
                  &middot;특히, 녹화된 영상이 아닌 실시간 카메라를 통해 좌석을 감지해야 했던 문제를 <u>기획 과정에서 선제적 식별</u>, 라우터를 사용한 네트워크 포트포워딩을 통해 실시간 IP 카메라 스트리밍을 클라이언트 단에 송출하여 해결<br></br>
            ...
            <ProjectCard
              ...
              description={
                <span>
                  ...
                  <br></br>
                  <b className="purple">&bull; 배운 점</b><br></br>
                  데이터 처리 및 분석 용도에 따른 명확하고 쉬운 데이터 구조 설계의 중요성을 배움. <u>명확한 문제 정의 기반의 이해하기 쉬운 데이터 아키텍처의 설계</u>는 곧, 추후 효율적이고 간편한 분석 작업을 가능하게 하며
